    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRUD_chocolateria.categoria')),
            ],
        ),
        migrations.CreateModel(
            name='Boleta',
            fields=[
                ...
                ('idProducto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRUD_chocolateria.producto')),
                ('idUsuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRUD_chocolateria.usuarios')),
            ],
        ),
    ]
